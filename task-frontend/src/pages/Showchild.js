    ...
    <div className={`task ${''}`}>
      ...
      {mode === "1" &&
        ...
        <form className='quiz-form'>
          ...
          <div>
            <div>
            {/* (score_test.score / 100) * (text.weight / all_weight_sd) * testweight_ */}
              ผู้ประเมินตอบ : {score_test.sd_choice} ได้ผลคะแนน : {(score_test.score / 100) * (text.weight / all_weight_sd) * testweight_} คะแนน
              <br></br>
